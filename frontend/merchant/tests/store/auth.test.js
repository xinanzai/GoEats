...
describe('Auth Store', () => {
  ...
  describe('initial state', () => {
    ...
    it('should not be merchant initially', () => {
  ...
  describe('computed properties', () => {
    ...
    it('should be merchant when role is merchant', () => {
      authStore.userInfo = { role: 'merchant' }
      expect(authStore.isMerchant).toBe(true)
    })

    it('should not be merchant when role is not merchant', () => {
  ...
  describe('logout', () => {
    ...
    it('should remove items from localStorage', () => {
      ...
      localStorage.setItem('user_info', JSON.stringify({ role: 'merchant' }))
      authStore.logout()
